...
x1 = np.linspace(1, len(r_pass_list), len(r_pass_list))
x2 = np.linspace(1, len(r_fail_list), len(r_fail_list))
plt.scatter(x1, r_pass_list)
plt.scatter(x2, r_fail_list)
